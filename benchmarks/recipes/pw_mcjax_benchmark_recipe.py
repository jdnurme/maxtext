...
def main() -> int:
  ...
  base_output_directory = f"gs://{user}/pw_mcjax_benchmarking/"
  ...
  pathways_config = mxr.PathwaysConfig(
      ...
      runner_image=RUNNER,
      server_flags="--temporary_flags_for_debugging=temporary_flag_for_debugging_worker_expected_tpu_chip_config=megachip_tccontrol",
  )
  num_slices_list = [
      2
  ]
