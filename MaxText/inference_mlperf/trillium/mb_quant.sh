...
QUANT_CFG="qkv_subchannel_512"
KV="int4"
BS=54
#S=64
REP_SCALE=true
run_name="trillium_llama2-70b-quant-$QUANT_CFG-${KV}-bs${BS}-newtopo-${REP_SCALE}"
dry_run=false
...
quantization=${QUANTIZATION} quant_cfg_path=${QUANT_CFG_PATH} replicate_quant_scale=${REP_SCALE} \
quantize_kvcache=True kv_quant_dtype=${KV} inference_microbenchmark_stages=${stages} \
